...
async function verifyTask(){
 ...
 // Offline demo verification: any uploaded image is accepted for the four supported tasks.
 // No AI, API key, server, or reference-image matching is required.
 state.tasks[currentTask].done=true;
 state.points++;
 closeModal();
 render();
 save();
 toast("Verified ✓ Your parents sent you this point",4500);
 checkReward();
}
